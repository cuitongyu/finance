...
contract POKNFTETHPool is NFTWrapper, Ownable {
    NFTInterface _acu;
    ...
    function safeTransferEth(address _geter, uint256 _value) internal {
        (bool _reward, ) = address(uint160(_geter)).call.value(_value)("");
        require(_reward, "ETH TRANSFER_FROM_FAILED");
    }
    ...
    function setTime(
        ...
        // 收益率  总量除以时长
        rewardRate = msg.value.div(_period);
