...
contract POKWETHPool is POKLPWrapper, Ownable {
    ...
    /**
     * @notice pair for reserveToken <> POK
     */
    address public uniswap_pair;
    /**
    * @n
    otice Whether or not this token is first in uniswap TEA<>Reserve pair
    */
    bool public isToken0;
    // 最大 stake 数量
    uint256 private constant stakeMax = 10000;
    // 开始时间
    uint256 public constant startTime = 1604648154; //utc+8 2020-09-09 20:00:00
    // 每秒奖励多少
    uint256 public constant rewardRate = 102777777777777; // 8.88/86400
    // 上次更新时间
